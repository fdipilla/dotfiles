...
#export PS1="\[$(tput setaf 1)\]┌─╼ \[$(tput setaf 7)\][\w]\n\[$(tput setaf 1)\]\$(if [[ \$? == 0 ]]; then echo \"\[$(tput setaf 1)\]└────\$(git_branch) ╼\"; else echo \"\[$(tput setaf 1)\]└╼ \"; fi) \[$(tput setaf 2) \]"
...
# My new favorite
export PS1="> \[\e[1;34m\]\w\[\e[m\]\[\e[1;37m\]\$(git_branch)\[\033[00m\] \[\e[1;32m\]\$\[\e[m\] "
